...
<head>
	...
	<title>House Rental Portal |Admin Manage Vehicles   </title>
...
<a href="manage-houses.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
