...
<head>
	...
	<title>House Rental Portal | Confirmed Bookings   </title>
...
{				?>	
										<tr>
											...
											<td><a href="edit-house.php?id=<?php echo htmlentities($result->vid);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></td>
