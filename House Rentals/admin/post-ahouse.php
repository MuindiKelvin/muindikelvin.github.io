...
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="radio" name="radio" value="1">
...
<input type="checkbox" id="parking" name="parking" value="1">
<label for="inlineCheckbox5"> Parking </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="bedding" name="bedding" value="1">
<label for="bedding">Bedding </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="cabletv" name="cabletv" value="1">
...
<label for="cdplayer"> CD/DVD </label>
</div>
</div>
<div class="col-sm-3">
...
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="gated" name="gated" value="1">
